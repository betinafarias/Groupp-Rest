...
--
-- Host: localhost
-- Generation Time: Nov 29, 2016 at 09:59 PM
...
CREATE TABLE IF NOT EXISTS `match` (
  ...
  `id_musician_matched` int(11) NOT NULL
...
INSERT INTO `musician` (`id`, `name`, `password`, `email`, `age`, `id_city`, `bio`) VALUES
(1, 'Betina', '1234', 'betina@gmail.com', 21, 4174, 'Sou uma pessoa feliz e amigável'),
(4, 'Bob Marley', '1234', 'bob@gmail.com', 43, 4174, 'Rastafari na veia'),
(7, 'front end', '12312312', 'ewqeqw@asddas', 32, 1574, ''),
(8, 'front post', '1234', 'tt@gmail.com', 43, 1495, ''),
(9, 'Cara estranho', '1234', 'cara@gmail.com', 43, 1495, ''),
(10, 'sadasd', '12312321', 'asdsad@asdsad', 213123, 1575, ''),
(11, 'adsfdas', '12312312', 'asdsad@asdsad', 12312, 1573, ''),
(12, 'sadasdasd', '21321321', 'asdsa@asdasd', 12312, 1574, '');

-- --------------------------------------------------------

--
-- Stand-in structure for view `musician_full_view`
--
CREATE TABLE IF NOT EXISTS `musician_full_view` (
`id` int(11)
,`name` varchar(50)
,`password` varchar(30)
,`email` varchar(120)
...
--
-- Table structure for table `musician_genre`
--
...
--
-- Dumping data for table `musician_genre`
--

INSERT INTO `musician_genre` (`id`, `id_musician`, `id_genre`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 1),
(4, 1, 2);
...
INSERT INTO `musician_instrument` (`id`, `id_musician`, `id_instrument`, `level`) VALUES
(1, 1, 1, 1),
(2, 9, 1, 0),
(3, 9, 2, 0),
(4, 10, 3, 0),
...
INSERT INTO `state` (`id`, `name`, `uf`, `id_country`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
--
-- Structure for view `musician_full_view`
--
DROP TABLE IF EXISTS `musician_full_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `musician_full_view` AS select `musician`.`id` AS `id`,`musician`.`name` AS `name`,`musician`.`password` AS `password`,`musician`.`email` AS `email`,`musician`.`age` AS `age`,`musician`.`id_city` AS `id_city`,`musician`.`bio` AS `bio`,`city`.`name` AS `city_name`,`instrument`.`name` AS `instrument_name`,`state`.`uf` AS `state_uf`,`state`.`id` AS `id_state` from ((((`musician` left join `city` on((`city`.`id` = `musician`.`id_city`))) left join `musician_instrument` on((`musician_instrument`.`id_musician` = `musician`.`id`))) left join `instrument` on((`instrument`.`id` = `musician_instrument`.`id_instrument`))) left join `state` on((`state`.`id` = `city`.`id_state`)));
...
ALTER TABLE `city`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Cidade_estado` (`id_state`);
...
--
-- Indexes for table `musician_genre`
--
ALTER TABLE `musician_genre`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `state`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Estado_pais` (`id_country`);
...
--
-- AUTO_INCREMENT for table `musician_genre`
--
ALTER TABLE `musician_genre`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `musician_instrument`
--
ALTER TABLE `musician_instrument`
...
--
ALTER TABLE `musician`
  ADD CONSTRAINT `musician_ibfk_1` FOREIGN KEY (`id_city`) REFERENCES `city` (`id`);

--
-- Constraints for table `musician_genre`
--
ALTER TABLE `musician_genre`
  ADD CONSTRAINT `musician_genre_ibfk_1` FOREIGN KEY (`id_genre`) REFERENCES `genre` (`id`);

--
-- Constraints for table `musician_instrument`
--
ALTER TABLE `musician_instrument`
  ADD CONSTRAINT `musician_instrument_ibfk_1` FOREIGN KEY (`id_musician`) REFERENCES `musician` (`id`),
  ADD CONSTRAINT `musician_instrument_ibfk_2` FOREIGN KEY (`id_instrument`) REFERENCES `instrument` (`id`);
